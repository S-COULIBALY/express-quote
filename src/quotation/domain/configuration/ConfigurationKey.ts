 ...
 * - Les valeurs par défaut sont en table Configuration (quotation-module).
 */
export enum ConfigurationCategory {
  // Catégories actives (table Configuration)
  ...
  BUSINESS_RULES = "BUSINESS_RULES", // Règles métier
  LIMITS = "LIMITS", // Limites générales
  GEOGRAPHIC_CONFIG = "GEOGRAPHIC_CONFIG", // Configuration géographique
}

/**
 * ✅ CLÉS DE CONFIGURATION PRIX (table Configuration / quotation-module)
 *
 * 🎯 OBJECTIF :
 * Noms des clés utilisées par la table Configuration
...
export enum PricingConfigKey {
  ...
  WEEKLY_RATE_MULTIPLIER = "WEEKLY_RATE_MULTIPLIER",
  EXTRA_DAY_DISCOUNT_RATE = "EXTRA_DAY_DISCOUNT_RATE",
  EXTRA_WORKER_DISCOUNT_RATE = "EXTRA_WORKER_DISCOUNT_RATE",
  VOLUME_DISCOUNT_THRESHOLD_M3 = "VOLUME_DISCOUNT_THRESHOLD_M3",
  ...
  // Équipement & Matériel
  EQUIPMENT_RENTAL_DAILY = "EQUIPMENT_RENTAL_DAILY", // → EQUIPMENT_RENTAL_DAILY
  MATERIAL_COST_PER_M3 = "MATERIAL_COST_PER_M3", // → MATERIAL_COST_PER_M3
  PROTECTIVE_EQUIPMENT_COST = "PROTECTIVE_EQUIPMENT_COST", // → PROTECTIVE_EQUIPMENT_COST

  // Opérationnel
  MAX_WORKERS_PER_VEHICLE = "MAX_WORKERS_PER_VEHICLE", // → MAX_WORKERS_PER_VEHICLE
  MAX_VOLUME_PER_VEHICLE_M3 = "MAX_VOLUME_PER_VEHICLE_M3", // → MAX_VOLUME_PER_VEHICLE_M3
  STANDARD_SERVICE_DURATION_HOURS = "STANDARD_SERVICE_DURATION_HOURS", // → STANDARD_SERVICE_DURATION_HOURS
  OVERTIME_RATE_MULTIPLIER = "OVERTIME_RATE_MULTIPLIER", // → OVERTIME_RATE_MULTIPLIER
  HOURS_PER_DAY = "HOURS_PER_DAY", // → HOURS_PER_DAY

  // Assurance
  INSURANCE_PRICE_HT = "INSURANCE_PRICE_HT", // → INSURANCE_PRICE_HT
  INSURANCE_PRICE_TTC = "INSURANCE_PRICE_TTC", // → INSURANCE_PRICE_TTC
  INSURANCE_COVERAGE_MINIMUM = "INSURANCE_COVERAGE_MINIMUM", // → INSURANCE_COVERAGE_MINIMUM

  // Qualité & Sécurité
  QUALITY_GUARANTEE_DAYS = "QUALITY_GUARANTEE_DAYS", // → QUALITY_GUARANTEE_DAYS
  SAFETY_EQUIPMENT_REQUIRED = "SAFETY_EQUIPMENT_REQUIRED", // → SAFETY_EQUIPMENT_REQUIRED

  // Professionnels
  PROFESSIONAL_DEFAULT_SEARCH_RADIUS_KM = "PROFESSIONAL_DEFAULT_SEARCH_RADIUS_KM", // → PROFESSIONAL_DEFAULT_SEARCH_RADIUS_KM

  // Auto-détection
  FURNITURE_LIFT_FLOOR_THRESHOLD = "FURNITURE_LIFT_FLOOR_THRESHOLD", // → FURNITURE_LIFT_FLOOR_THRESHOLD
  FURNITURE_LIFT_SURCHARGE = "FURNITURE_LIFT_SURCHARGE", // → FURNITURE_LIFT_SURCHARGE
  LONG_CARRYING_DISTANCE_THRESHOLD = "LONG_CARRYING_DISTANCE_THRESHOLD", // → LONG_CARRYING_DISTANCE_THRESHOLD
  LONG_CARRYING_DISTANCE_SURCHARGE = "LONG_CARRYING_DISTANCE_SURCHARGE", // → LONG_CARRYING_DISTANCE_SURCHARGE
}
 ...
 *
 * 📝 NOTE :
 * Ces clés correspondent aux constantes commentées dans ts
 * Elles seront réactivées lors de futures implémentations
 */
export enum BusinessRulesConfigKey {
  // Règles de réservation (actuellement commentées dans ts)
...
/**
 * ✅ CLÉS DE CONFIGURATION SYSTÈME - Alignement avec ts (APRÈS NETTOYAGE)
 *
 * ✅ CONSTANTES ACTIVES (noms identiques à ts) :
...
export enum SystemValuesConfigKey {
  ...
  DEFAULT_CURRENCY = "DEFAULT_CURRENCY", // → DEFAULT_CURRENCY
  DEPOSIT_PERCENTAGE = "DEPOSIT_PERCENTAGE", // → DEPOSIT_PERCENTAGE (nouveau)
  MIN_PRICE = "MIN_PRICE", // → MIN_PRICE
}

export enum TechnicalLimitsConfigKey {
  MIN_VOLUME = "MIN_VOLUME", // → MIN_VOLUME
  MAX_VOLUME = "MAX_VOLUME", // → MAX_VOLUME
  MIN_SQUARE_METERS = "MIN_SQUARE_METERS", // → MIN_SQUARE_METERS
}

...
/**
 * CLÉS DE CONFIGURATION PRIX - Alignement exact avec DefaultValues.ts
 * 
 * 🎯 OBJECTIF :
...
export enum PricingConfigKey {
  // PRIX UNITAIRES DE BASE - Noms identiques à DefaultValues.ts
  UNIT_PRICE_PER_M3 = 'UNIT_PRICE_PER_M3',                      // → DefaultValues.UNIT_PRICE_PER_M3
  UNIT_PRICE_PER_KM = 'UNIT_PRICE_PER_KM',                      // → DefaultValues.UNIT_PRICE_PER_KM
  EXTRA_KM_PRICE = 'EXTRA_KM_PRICE',                            // → DefaultValues.EXTRA_KM_PRICE
  
  // PRIX OUVRERS ET ÉQUIPEMENTS - Noms identiques à DefaultValues.ts
  WORKER_PRICE = 'WORKER_PRICE',                                // → DefaultValues.WORKER_PRICE
  LIFT_PRICE = 'LIFT_PRICE',                                    // → DefaultValues.LIFT_PRICE
  WORKER_HOUR_RATE = 'WORKER_HOUR_RATE',                        // → DefaultValues.WORKER_HOUR_RATE
  EXTRA_WORKER_HOUR_RATE = 'EXTRA_WORKER_HOUR_RATE',            // → DefaultValues.EXTRA_WORKER_HOUR_RATE
  
  // FRAIS FIXES & FORFAITS - Noms identiques à DefaultValues.ts
  VEHICLE_FLAT_FEE = 'VEHICLE_FLAT_FEE',                        // → DefaultValues.VEHICLE_FLAT_FEE
  INCLUDED_DISTANCE = 'INCLUDED_DISTANCE',                      // → DefaultValues.INCLUDED_DISTANCE
  
  // FRAIS VARIABLES TRANSPORT - Noms identiques à DefaultValues.ts
  ...
  // RÉDUCTIONS & RABAIS - Noms identiques à DefaultValues.ts
  ...
  // PARAMÈTRES DE TARIFICATION COMPLÉMENTAIRES - Noms identiques à DefaultValues.ts
...
/**
 * CLÉS DE CONFIGURATION SYSTÈME - Alignement exact avec DefaultValues.ts
 * 
 * ✅ CONSTANTES ACTIVES (noms identiques à DefaultValues.ts) :

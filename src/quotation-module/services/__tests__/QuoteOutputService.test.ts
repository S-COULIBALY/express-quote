...
describe('QuoteOutputService', () => {
  ...
  describe('generateTerrainChecklist', () => {
    it('devrait générer une checklist terrain', () => {
      ...
      const checklist = QuoteOutputService.generateTerrainChecklist(ctx, 'test-quote-123');
  ...
  describe('generateContractData', () => {
    it('devrait générer les données contrat', () => {
      ...
      const contractData = QuoteOutputService.generateContractData(ctx, 'test-quote-123');
  ...
  describe('generateLegalAudit', () => {
    it('devrait générer un audit juridique', () => {
      ...
      const audit = QuoteOutputService.generateLegalAudit(ctx, 'test-quote-123');
  ...
  describe('generateComparisonSummary', () => {
    it('devrait générer un résumé comparatif', () => {
      const variants = [
        { scenarioId: 'ECO', label: 'Économique', finalPrice: 1000, marginRate: 0.20 },
        { scenarioId: 'STANDARD', label: 'Standard', finalPrice: 1200, marginRate: 0.30 },
        { scenarioId: 'PREMIUM', label: 'Premium', finalPrice: 1500, marginRate: 0.40 },
      ];

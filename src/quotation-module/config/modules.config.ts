...
export const MODULES_CONFIG = {
  ...
  furnitureLift: {
    ...
    /**
     * Pénalité par étage sans ascenseur (€)
     * Basé sur le marché français : 50-80€/étage
     * IMPORTANT : Cette pénalité est ANNULÉE si le monte-meuble est accepté
     */
    FLOOR_PENALTY_PER_FLOOR: 65,
  },

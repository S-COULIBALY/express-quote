...
export default function CataloguePage() {
  ...
  const nextSlide = () => {
    const itemsToUse =
      randomizedItems.length > 0 ? randomizedItems : fallbackItems;
    setCurrentCarouselIndex((prevIndex) => (prevIndex + 1) % itemsToUse.length);
  };
  ...
  const groupedItems = catalogItems.reduce(
    (acc, item) => {
  ...
  const IconComponent = currentItem
    ? getCategoryIcon(currentItem.category, currentItem.subcategory)
    : TruckIcon;
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-xl mx-auto lg:mx-0 mb-6 font-ios leading-relaxed">
                Évitez les forfaits rigides ! Nos services{" "}
                <span className="font-bold text-emerald-600">
                  modulaires et flexibles
                </span>{" "}
                vous permettent de contrôler votre budget et d'optimiser vos
                dépenses
              </p>
              ...
              {orderedCategories.length === 0 ? (
                ...
                orderedCategories.map((category) => (
                  <div
                    ...
                    className="card-ios p-6 hover:shadow-xl transition-all duration-300"
                  >
                    <div className="flex items-center gap-3 mb-4">
                      <div
                        className={`w-10 h-10 rounded-lg ${getCategoryColor(category).replace("text-", "bg-")} flex items-center justify-center shadow-lg`}
                      >
                      ...
                      <div>
                        <h3
                          className={`text-xl font-bold ${getCategoryColor(category)} flex items-center gap-2`}
                        >
                    ...
                    <div className="flex flex-wrap gap-3">
                      {groupedItems[category]?.map((item, _index) => {
                        ...
                        const isPopular =
                          item.badgeText === "Populaire" || item.isFeatured;
                          ...
                          >
                            ...
                            <div className="card-ios p-4 h-full flex flex-col overflow-hidden">
                              ...
                              <div className="flex items-center justify-between mb-3">
                                <div
                                  className={`w-10 h-10 rounded-lg ${categoryColor.replace("text-", "bg-")}/10 flex items-center justify-center shadow-sm group-hover:scale-110 transition-transform duration-300`}
                                >
                                  <IconComponent
                                    className={`w-5 h-5 ${categoryColor}`}
                                  />
                                </div>
                                {item.isFeatured && (
                              ...
                              <div className="flex-1 flex flex-col">
                                <h4 className="font-bold text-gray-900 text-base mb-2 line-clamp-2 group-hover:text-emerald-700 transition-colors duration-300">
                                  {item.title}
                                </h4>
                                ...
                                <div className="flex items-center justify-between mt-auto mb-3">
                                  <div className="flex flex-col gap-1">
                                    <div className="flex items-center gap-2">
                                      ...
                                      <span
                                        className={`text-xl font-bold ${item.originalPrice && item.originalPrice > item.price ? "text-red-600" : "text-gray-900"}`}
                                      >
                                        €{item.price}
                                      </span>
                                    </div>
                                  ...
                                  <div className="flex flex-col items-end gap-1">
                                    <span
                                      className={`text-xs font-medium text-white ${categoryColor.replace("text-", "bg-")} px-1.5 py-0.5 rounded-full`}
                                    >
                                      {item.duration} Heure
                                      {item.duration > 1 ? "s" : ""}
                                    </span>
      ...
      <div className="bg-gradient-to-br from-emerald-50 to-green-50 py-16 border-t border-emerald-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="card-ios p-8 hover:shadow-2xl transition-all duration-500 group-hover:scale-105 group-hover:-translate-y-2 relative overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <p className="text-gray-600 mb-6 leading-relaxed">
                    À partir de{" "}
                    <span className="font-bold text-emerald-600">19€/h</span> -
            ...
            >
              <div className="card-ios p-8 hover:shadow-2xl transition-all duration-500 group-hover:scale-105 group-hover:-translate-y-2 relative overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <p className="text-gray-600 mb-6 leading-relaxed">
                    À partir de{" "}
                    <span className="font-bold text-blue-600">21€/h</span> -
            ...
            <button
              onClick={() => {
                const transportItems = catalogItems.filter(
            ...
            <button
              onClick={() => {
                const livraisonItems = catalogItems.filter(
                  (item) => item.category === "LIVRAISON",
                );

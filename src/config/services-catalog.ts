...
export const SERVICES: ServiceDefinition[] = [
  // --- EMBALLAGE ---
  {
    ...
    description: 'Service d\'emballage complet par nos équipes qualifiées. Inclut protection et mise en carton de tous vos biens.',
  ...
  // --- DÉMONTAGE / REMONTAGE ---
  {
    ...
    description: 'Démontage professionnel de vos meubles par des techniciens qualifiés. Outillage professionnel inclus.',
  ...
  },
  {
    ...
    description: 'Remontage garanti conforme de tous vos meubles démontés. Vérification du bon fonctionnement.',
  ...
  // --- MANUTENTION SPÉCIALISÉE ---
  {
    ...
    description: 'Transport spécialisé pour piano. Équipement adapté, équipe formée et assurance renforcée.',
  ...
  },
  {
    ...
    description: 'Manutention spécialisée pour coffres-forts. Équipement hydraulique si nécessaire.',
  ...
  },
  {
    ...
    description: 'Protection et transport spécialisé pour œuvres d\'art. Caissage sur mesure disponible.',
  ...
  // --- NETTOYAGE ---
  {
    ...
    description: 'Nettoyage complet de votre ancien logement. Idéal pour récupérer votre dépôt de garantie.',
...
export const OPTIONS: ServiceDefinition[] = [
  {
    ...
    description: 'Stockage sécurisé de vos biens en garde-meuble climatisé. Accès possible 24h/24.',
...
export const SUPPLIES: SupplyDefinition[] = [
  ...
  },
  {
    ...
    description: '40 cartons standards + 10 cartons livres + 5 penderies + scotch',
    icon: '📦',
    category: 'FOURNITURE',
    price: 89,
    unit: 'pack',
  ...
  },
  {
    ...
    description: '60 cartons standards + 15 cartons livres + 10 penderies + accessoires',
    icon: '📦',
    category: 'FOURNITURE',
    price: 129,
    unit: 'pack',
  ...
  // --- PROTECTIONS ---
  {
    ...
    description: 'Protection optimale pour objets fragiles. Rouleau de 50m × 1m.',
    icon: '🫧',
    category: 'FOURNITURE',
    price: 25,
    unit: 'rouleau',
  ...
  },
  {
    ...
    description: 'Couvertures matelassées pour protéger meubles et objets volumineux.',
    icon: '🛡️',
    category: 'FOURNITURE',
    price: 35,
    unit: 'lot de 10',
  ...
  },
  {
    ...
    description: 'Housse de protection imperméable pour matelas 1 place (90×190cm).',
    icon: '🛏️',
    category: 'FOURNITURE',
    price: 12,
    unit: 'pièce',
  ...
  },
  {
    ...
    description: 'Housse de protection imperméable pour matelas 2 places (140×190cm).',
    icon: '🛏️',
    category: 'FOURNITURE',
    price: 15,
    unit: 'pièce',
  ...
  },
  {
    ...
    description: 'Housse de protection imperméable pour grand matelas (160×200cm+).',
    icon: '🛏️',
    category: 'FOURNITURE',
    price: 18,
    unit: 'pièce',
  ...
  },
  {
    ...
    description: 'Film plastique étirable pour sécuriser tiroirs et portes de meubles.',
    icon: '🎞️',
    category: 'FOURNITURE',
    price: 15,
    unit: 'rouleau',
  ...
  switch (service.pricingType) {
    ...
    case 'CALCULATED':
      ...
      if (service.id === 'dismantling' || service.id === 'reassembly') {
        ...
        if (context.rooms && context.rooms >= 4) price += 50; // 2 meubles complexes

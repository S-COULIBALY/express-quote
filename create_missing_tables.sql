...
CREATE TABLE "rules" (
    ...
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "percentBased" BOOLEAN NOT NULL DEFAULT true,
    "condition" TEXT,
...
-- CreateIndex
CREATE INDEX "Booking_customerId_idx" ON "Booking"("customerId" ASC);

-- CreateIndex
CREATE INDEX "Booking_professionalId_idx" ON "Booking"("professionalId" ASC);

-- CreateIndex
CREATE INDEX "Booking_status_idx" ON "Booking"("status" ASC);

-- CreateIndex
CREATE INDEX "Booking_type_idx" ON "Booking"("type" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "Customer_email_key" ON "Customer"("email" ASC);

-- CreateIndex
CREATE INDEX "Document_bookingId_idx" ON "Document"("bookingId" ASC);

-- CreateIndex
CREATE INDEX "Document_type_idx" ON "Document"("type" ASC);

-- CreateIndex
CREATE INDEX "EmailAttachment_documentId_idx" ON "EmailAttachment"("documentId" ASC);

-- CreateIndex
CREATE INDEX "EmailAttachment_emailId_idx" ON "EmailAttachment"("emailId" ASC);

-- CreateIndex
CREATE INDEX "EmailLog_bookingId_idx" ON "EmailLog"("bookingId" ASC);

-- CreateIndex
CREATE INDEX "EmailLog_customerId_idx" ON "EmailLog"("customerId" ASC);

-- CreateIndex
CREATE INDEX "EmailLog_status_idx" ON "EmailLog"("status" ASC);

-- CreateIndex
CREATE INDEX "Moving_bookingId_idx" ON "Moving"("bookingId" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "Moving_bookingId_key" ON "Moving"("bookingId" ASC);

-- CreateIndex
CREATE INDEX "Moving_moveDate_idx" ON "Moving"("moveDate" ASC);

-- CreateIndex
CREATE INDEX "Pack_bookingId_idx" ON "Pack"("bookingId" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "Pack_bookingId_key" ON "Pack"("bookingId" ASC);

-- CreateIndex
CREATE INDEX "Pack_scheduledDate_idx" ON "Pack"("scheduledDate" ASC);

-- CreateIndex
CREATE INDEX "Professional_businessType_idx" ON "Professional"("businessType" ASC);

-- CreateIndex
CREATE INDEX "Professional_city_idx" ON "Professional"("city" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "Professional_email_key" ON "Professional"("email" ASC);

-- CreateIndex
CREATE INDEX "Professional_verified_idx" ON "Professional"("verified" ASC);

-- CreateIndex
CREATE INDEX "Service_bookingId_idx" ON "Service"("bookingId" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "Service_bookingId_key" ON "Service"("bookingId" ASC);

-- CreateIndex
CREATE INDEX "Service_scheduledDate_idx" ON "Service"("scheduledDate" ASC);

-- CreateIndex
CREATE INDEX "Transaction_bookingId_idx" ON "Transaction"("bookingId" ASC);

-- CreateIndex
CREATE INDEX "Transaction_paymentIntentId_idx" ON "Transaction"("paymentIntentId" ASC);

-- CreateIndex
CREATE INDEX "Transaction_status_idx" ON "Transaction"("status" ASC);

-- CreateIndex
CREATE INDEX "Transaction_stripeSessionId_idx" ON "Transaction"("stripeSessionId" ASC);
